...
if __name__ == '__main__':
    first_buyer = Buyer(purchase_history=[], shopping_cart=[], shipping_address="Calle none 123", has_subscribed=True,
                        ...
                        city="Mendoza", zip_code="5572", phone="2634773945", email="maurigato@gmail.com", status=False)

    first_article = Article( id=str(uuid.uuid4()), name= "Philco", item_id=1, description= "TV Smart",
                             category="Electrodomesticos", price=100000.00,
                             stock=3, seller=first_buyer, average_rating=10, comments=["Muy Bueno", "Exelente"],
                             date_created=datetime.now(), shipping_methods=["Andreani", "Envio Express"],
                             buyer=first_buyer)
